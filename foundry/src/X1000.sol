...
contract X1000 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"A Degen's Wish";
    string private constant _symbol = unicode"X1000";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (
                !inSwap && from != uniswapV2Pair && swapEnabled && contractTokenBalance > _taxSwap
